...
<html lang="en">
  <head>
    ...
    <meta name="author" content="Sohal">
    <meta name="copyright" content="talenthub1">
    <title>Sarahah clone by Sohal</title>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="alert alert-success">
            <strong>Success!</strong> Thank you for your honesty :)
          </div>
